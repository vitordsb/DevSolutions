  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <section className={styles.servicesList}>
        <ServiceCard
          icon="/public/services/ConsultoriaService.jpg"
        ...
        />
        <ServiceCard
          icon="/public/services/desenvolvimentoService.jpg"
        ...
        />
        <ServiceCard
          icon="/public/services/DesignService.jpg"
        ...
        />
        <ServiceCard
          icon="/public/services/hardwareServices.jpg"
